...
<script type="text/javascript">
	$(function() {
		$("#goList").click(function() {
			location.href="galCatList.gc?curPage=1"
		});
	});
	$(function() {
		$("#title2").text("Gallery");
...
<style type="text/css">
	...
	#galCatwrite_btn input[type=button],#galCatwrite_btn input[type=reset]{
...
<body>
	...
	<div id="galCat_wbody">
	<form action="galCatWrite.gc" method="post" id="frm">
