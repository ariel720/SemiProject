...
<link href="<%=application.getContextPath() %>/css/noticeupdate.css" rel="stylesheet">
...
<div id="w_change">
<form action="update.nt" method="post" id="frm">
<div id="write_table">
<table id="t1">
<input type="hidden" value="${nt.num }"  name="num">
<%-- <tr><td>작성자</td><td><input type="text" name="id" readonly="readonly">${sessionScop.member.id}</td></tr> --%>
<colgroup>
<col width="12%">
<col width="88%">
</colgroup>
<tr class="tr1"><th>작성자</th><td ><input id="td1" type="text" name="id" readonly="readonly" value="${nt.id}"></td></tr>
<tr class="tr1"><th>제목</th><td ><input id="td2" type="text" name="title" value="${nt.title }">
	<input type="hidden" name="counts" value="${nt.counts}">
</td></tr>
<tr><th>내용</th><td><textarea name="smarteditor" id="smarteditor" rows="10" cols="60" style="width:99%; height:412px;">${nt.contents }</textarea></td></tr>
