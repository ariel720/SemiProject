    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/semiProject/galHo/galFileUp.gh'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/semiProject/galHo/galFileUp.gh',	//샘플 URL입니다.
 			//sUrl  : '/file_uploader.do',	//샘플 URL입니다.
 	        sCallback : '/semiProject/SE2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
