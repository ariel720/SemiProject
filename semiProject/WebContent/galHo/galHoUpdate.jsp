...
<style type="text/css">
	...
	#galHo_wbody, #galHo_wbody_h1,#up_d1{
		width: 1050px;
		margin: 0 auto;
	}
	.w{
...
<body>
	...
	<div id="galHo_ubody">
	<form action="galHoUpdate.gh" method="post" id="frm">
		<div id="galHo_wbody_h">
			<table id="galHo_wbody_h1">
				<tr>
					<td class="w">제목</td> <td>
					<input type="text" name="title" value="${requestScope.galHoView['title'] }">
					<input type="hidden" name="num" value="${requestScope.galHoView['num'] }">
					<input type="hidden" name="curPage" value="${param['curPage'] }">
					</td>
				</tr>
				<tr>	
					<td class="w">작성자</td><td><input type="text" name="id" value="${requestScope.galHoView['id'] }" readonly="readonly"></td>
				</tr>
				<tr>
					<td colspan="2"><textarea name="contents" id="smarteditor" rows="10" cols="100" style="width:1040px; height:500px;">${requestScope.galHoView['contents'] }</textarea></td>
				</tr>
			</table>
			<div id="up_d1">
