...
<link href="<%=application.getContextPath() %>/css/freewrite.css" rel="stylesheet">
...
<div id="w_change">
<form action="write.fr" method="post" id="frm">
<div id="write_table">
<table id="t1">
...
<tr class="tr1"><th>작성자</th><td ><input type="text" name="id" id="td1" value="${member.id }" readonly="readonly"></td></tr>
<tr class="tr1"><th>제목</th><td ><input type="text" name="title" id="td2"></td></tr>
<tr><th>내용</th><td><textarea name="smarteditor" id="smarteditor" rows="10" cols="60" style="width:100%; height:412px;"></textarea></td></tr>

</table>
<div id="button_div">
<input class="but" type="button" id="savebutton" value="완료" />
